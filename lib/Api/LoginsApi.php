...
class LoginsApi
{
     ...
     * @return \Swagger\Client\Model\Logins
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Logins, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginsGetWithHttpInfo($limit = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\Logins';
