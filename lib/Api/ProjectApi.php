...
class ProjectApi
{
     ...
     * @return \Swagger\Client\Model\Project
     */
    public function projectsIdPut($body, $id)
    {
        list($response) = $this->projectsIdPutWithHttpInfo($body, $id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Project, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectsIdPutWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Project';
        $request = $this->projectsIdPutRequest($body, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsIdPutAsync($body, $id)
    {
        return $this->projectsIdPutAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsIdPutAsyncWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Project';
        $request = $this->projectsIdPutRequest($body, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function projectsIdPutRequest($body, $id)
    {
